...
#endif
            VL_FATAL_MT("tb_riscv.sv", 3, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 100 tries");
        }
...
VL_ATTR_COLD void Vtb_riscv___024root___ctor_var_reset(Vtb_riscv___024root* vlSelf) {
    ...
    vlSelf->tb_riscv__DOT__dut__DOT__RegSrc2 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12806208322271605461ull);
    ...
    vlSelf->tb_riscv__DOT__dut__DOT__DmemWr = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15863390309343590972ull);
    ...
    vlSelf->__Vfunc_GetOpcode__3__Vfuncout = 0;
    vlSelf->__Vfunc_GetOpcode__3__RawInstr = 0;
